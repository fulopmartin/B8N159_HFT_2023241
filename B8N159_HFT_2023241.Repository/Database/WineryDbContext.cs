    ...
    public class WineryDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var wines = new List<Wine>()
            {
                ...
                new Wine(3,"Emma",2023,WineType.Fehér,1900,1),
                new Wine(4,"Gurovica",2021,WineType.Fehér,3300,1),
                new Wine(5,"Etalon",2020,WineType.Vörös,3600,1),
                new Wine(6,"Grand",2017,WineType.Vörös,25000,1),
                new Wine(7,"Gurovica",2016,WineType.Vörös,9000,1),
                new Wine(8,"No.1",2017,WineType.Vörös,40000,1),

                //bock winery
                new Wine(9,"Merlot Special Reserve",2015,WineType.Vörös,10450,2),
                new Wine(10,"Kékfrankos",2021,WineType.Vörös,2480,2),
                new Wine(11,"Cuvée",2016,WineType.Vörös,9050,2),
                new Wine(12,"Rajnai Rizling",2022,WineType.Fehér,3190,2),
                new Wine(13,"Olaszrizling",2022,WineType.Fehér,2100,2),
                new Wine(14,"Rosé Cuvée",2022,WineType.Rozé,2190,2),
                new Wine(15,"Primőr Rosé Cuvée",2023,WineType.Rozé,2190,2),                           
                new Wine(16,"Libra",2017,WineType.Vörös,22250,2),                           
               
                //frittmann winery
                new Wine(17,"Rosé Cuvée",2017,WineType.Rozé,1500,3),                        
                new Wine(18,"Néró Rosé",2017,WineType.Rozé,1400,3),                        
                new Wine(19,"Kadarka Fpv",2015,WineType.Vörös,1500,3),                        
                new Wine(20,"Portugieser",2017,WineType.Vörös,1190,3),                        
                new Wine(21,"Duett",2020,WineType.Vörös,2390,3),                      
                new Wine(22,"Olívia",2023,WineType.Fehér,1690,3),                      
                new Wine(23,"Irsai Olivér",2023,WineType.Fehér,1790,3),                        
                new Wine(24,"Cserszegi Fűszeres",2017,WineType.Fehér,1700,3),                        
                
                //mészáros pál winery
                new Wine(25,"Kékfrankos Classic",2020,WineType.Vörös,1790,4),                        
                new Wine(26,"Grand Antiqua Merlot",2016,WineType.Vörös,18900,4),                        
                new Wine(27,"Chardonnay Classic",2022,WineType.Fehér,1670,4),                        
                new Wine(28,"Fehér Kadarka",2022,WineType.Fehér,1820,4),                        
                new Wine(29,"Grandiózus Cuvée",2020,WineType.Vörös,4520,4),                        
                new Wine(30,"Irsai Olivér",2022,WineType.Fehér,1950,4),                        
                new Wine(31,"Rosé",2022,WineType.Rozé,1690,4),                        
                new Wine(32,"Kadarka",2019,WineType.Vörös,2390,4),  
                
                //takler winery
                new Wine(33,"Örökség Bikavér",2018,WineType.Vörös,4290,5),                        
                new Wine(34,"Trió Vörös",2019,WineType.Vörös,2450,5),                        
                new Wine(35,"Syrah",2020,WineType.Vörös,2950,5),                        
                new Wine(36,"Királyleányka",2022,WineType.Fehér,2200,5),                        
                new Wine(37,"Trió Fehér",2022,WineType.Fehér,1800,5),                        
                new Wine(38,"Pinot Noir Rosé",2022,WineType.Rozé,2000,5),                        
                new Wine(39,"Rozetta",2022,WineType.Rozé,1900,5),                        
                new Wine(40,"Regnum",2019,WineType.Vörös,8900,5),                        
